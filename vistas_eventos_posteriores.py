...
template = env.get_template('eventos_futuros.html')



def eventos_posteriores(environ, start_response, eventos_futuros): 
    response = template.render(eventos_futuros=eventos_futuros).encode('utf-8')
    status = '200 OK'
